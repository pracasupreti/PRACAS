  ...
  <div className="grid grid-cols-2 gap-6">
    ...
    <div className="mb-4">
      ...
      <input
        ...
        className="mt-1 block w-full px-3 py-1 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-600  focus:border-blue-800"
        required
      />
    </div>
    ...
    <div className="mb-4">
      ...
      <input
        ...
        onChange={handleChange}
        className="mt-1 block w-full px-3 py-1 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
        required
      />
    </div>
    ...
    <div className="mb-4 text-sm font-semibold">
      ...
      <input
        ...
        value={formData.city}
        onChange={handleChange}
        className="mt-1 block w-full px-3 py-[5px] border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
        required
      />
    </div>
    ...
    <div className="mb-4">
      ...
      <select
        ...
        className="mt-1 block w-full px-3 py-1 border border-gray-300 rounded-xl shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
      >
        <option value="Unemployed">Contract</option>
    ...
    <select
      ...
      >
        ...
        <option value="satur"> Satruday 11 AM to 7 PM</option>
        <option value="others"> Others</option>
    ...
    <div className="mb-4 flex justify-end col-span-2">
      <div className='flex lg:mr-[650px] mr-[290px] sm:mr-[400px] md:mr-[530px] '>
        <IoReload  className='md:mt-[11px] mt-[8px] sm:mt-[8px] text-blue-600'/>
        <h1 onClick={handleClearForm}
          className=" text-blue-600 text-sm sm:text-lg w-[88px] mt-2  cursor-pointer " >
          Clear form
        </h1>
      </div>
      ...
      <button
        type="submit"
        className="bg-gray-500 text-white px-3 py-2 mb-3 rounded-md shadow-md hover:bg-indigo-700"
      >
        Submit
      </button>
    </div>
